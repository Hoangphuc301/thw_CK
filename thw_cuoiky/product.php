...
<h2 style="margin-top: 30px; text-align: center; color: #333; padding-bottom: 10px; border-bottom: 2px solid #007bff;">
    TẤT CẢ SẢN PHẨM
</h2>
...
<?php else: ?>
    <p style="text-align: center; padding: 50px;">Không có sản phẩm nào để hiển thị.</p>
<?php endif; ?>
